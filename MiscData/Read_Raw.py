...
if __name__ == "__main__":
    ...
    plt.scatter(val1.index, val1.to_numpy(), color='red', s = 3, label='Missing timestamps')
    plt.scatter(val2.index, val2.to_numpy(), color='brown', s = 3, label='Bad timestamps')
    plt.scatter(val3.index, val3.to_numpy(), color='limegreen', s = 3, label='Good timestamps')
    plt.scatter(val4.index, val4.to_numpy(), color='green', s = 3, label='OK timestamps')
    plt.legend()
    plt.ylim(-2.5, 1.5)
